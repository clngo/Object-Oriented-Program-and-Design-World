...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        System.out.println("Basil is here!");
        ...
        Background headspace = new Background("headspace", imageStore.getImageList("headspace"));
        world.setBackgroundCell(pressed, headspace); //center
        List<Point> bg = List.of(
        ...
        for (Point p : bg) {
            if (world.withinBounds(p)) {
                world.setBackgroundCell(p, headspace);
                if (world.getOccupancyCell(p) instanceof Tree tree) {
                    tree.moletransform(world, scheduler, imageStore);
                }
            }

        }
        Basil basil = new Basil("Basil", pressed, imageStore.getImageList(WorldModel.BASIL_KEY));
    ...
    public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        for (Entity entity : world.getEntities()) {
            if (entity instanceof ScheduleEntity entityschedule) {
                entityschedule.scheduleActions(scheduler, world, imageStore);
            }
