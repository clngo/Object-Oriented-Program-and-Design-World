...
public final class WorldModel {
    ...
    public static final String BASIL_KEY = "basil";
    public static final String WATERMELON_KEY = "watermelon";
    public static final String REDHAND_KEY = "redhand";
    ...
    public void parseEntity(WorldModel world, String line, ImageStore imageStore) {
    ...
    public void parseSapling(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
    ...
    public void parseDude(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == DUDE_NUM_PROPERTIES) {
            Dude_NotFull entity = new Dude_NotFull(id, pt, imageStore.getImageList(DUDE_KEY), Double.parseDouble(properties[DUDE_ACTION_PERIOD]), Double.parseDouble(properties[DUDE_ANIMATION_PERIOD]), Integer.parseInt(properties[DUDE_LIMIT]));
            world.tryAddEntity(entity);
        }else{
    ...
    public void parseFairy(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
    ...
    public void parseTree(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
    ...
    public void parseObstacle(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
    ...
    public void parseHouse(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
    ...
    public void parseStump(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
